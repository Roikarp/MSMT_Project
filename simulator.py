...
class Simulator:
    ...
    def calc_statitstics(self, to_stdout=False):
        ...
        self.total_cpi = get_cycle() / sum([t.get_inst_cnt() for t in self.threads])
